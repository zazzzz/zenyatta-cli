...
function zenyatta(program) {
  ...
  try {
    ...
    (0, _utils.renderFile)(template + '/index', config, function (source) {
    ...
    (0, _utils.renderFile)(style + '/style', {}, function (source) {
    ...
    (0, _utils.renderFile)(style + '/script', {}, function (source) {
      (0, _utils.writeJSFile)(name + '.js', source, dir);
